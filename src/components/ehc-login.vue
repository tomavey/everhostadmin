...
export default {
  ...
  data () {
    return {
        ...
        picOptions: [
            { fileName: "shutterstock_62211796.jpg", position: "bottom -5rem left -30rem", mobilePosition: "bottom 10rem left -0rem"},
            { fileName: "shutterstock_557019241.jpg", position: "top 0px left -48rem", mobilePosition: "top -9rem left -35rem"},
            { fileName: "shutterstock_1141204517.jpg", position: "bottom 0px left -7rem", mobilePosition: "bottom 17rem left -4rem"},
        ],
        showSignUp: false,
